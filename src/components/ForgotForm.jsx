const ForgotForm = () => {
    return(
        <div>
            ...
            <h1 className="text-3xl font-semibold ">Olvidaste tu Contaseña?</h1>
            <p className="font-medium text-lg text-gray-500 mt-4">No te preocupes! </p>
            <p className="font-medium text-lg text-gray-500 ">Escribe tu email y recibiras <br />instrucciones de como cambiar tu Contraseña</p>
            <div className="mt-8 ">
                <div>
